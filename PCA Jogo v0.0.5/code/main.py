...
def cadastro():
    ...
    def write_form(new_data, filename='data/data.json'):
    ...
    while True:
        ...
        text_surface = inputFont.render(user_text, True, black)
        ...
        pygame.draw.rect(screen, blue, (310, 300, 200, 100))
    ...
    def checarLogin(nome):
        for item in data['players']:
            if nome in item['nome']:
                print(f"Bem vindo, {user_text}!")
            else:
                print("Nenhum usuario foi encontrado com este nome! :(")
